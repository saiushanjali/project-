      ...
      <div className="relative z-10 w-full max-w-[460px]">
        ...
        <div className="glass-panel-dark rounded-3xl p-8 sm:p-10 shadow-2xl border border-slate-800">
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-xs text-slate-400 mt-1.5">Start optimizing shipments across the FreightIQ network</p>
          </div>
          ...
          <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
            ...
            <div className="flex items-start text-left py-1">
              <input
                ...
                type="checkbox"
                required
                className="w-4.5 h-4.5 rounded border-slate-800 bg-slate-900 text-primary-600 focus:ring-primary-500 focus:ring-offset-slate-950 focus:outline-none mt-0.5"
              />
              <label htmlFor="terms" className="ml-2.5 text-xs text-slate-400 leading-normal font-semibold cursor-pointer">
                I agree to the <a href="#" className="text-primary-400 hover:underline">Terms of Service</a> and privacy rules
              </label>
            </div>
