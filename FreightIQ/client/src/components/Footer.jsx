...
function Footer() {
  ...
  return (
    <footer className="bg-slate-950 border-t border-slate-900 text-slate-400 py-16 sm:py-24 relative overflow-hidden bg-grid-pattern-dark">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 lg:gap-8 pb-16 border-b border-slate-900">
          ...
          <div className="lg:col-span-2 space-y-6 text-left">
            ...
            <div className="flex gap-4">
              <a href="#" className="p-2 rounded-lg bg-slate-900 border border-slate-800 hover:border-slate-700 text-slate-400 hover:text-white transition-colors" aria-label="Twitter">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
              </a>
              <a href="#" className="p-2 rounded-lg bg-slate-900 border border-slate-800 hover:border-slate-700 text-slate-400 hover:text-white transition-colors" aria-label="LinkedIn">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                  <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
                </svg>
              </a>
              <a href="#" className="p-2 rounded-lg bg-slate-900 border border-slate-800 hover:border-slate-700 text-slate-400 hover:text-white transition-colors" aria-label="GitHub">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
              ...
              <a href="#" className="p-2 rounded-lg bg-slate-900 border border-slate-800 hover:border-slate-700 text-slate-400 hover:text-white transition-colors" aria-label="Globe">
        ...
        <div className="pt-12 flex flex-col lg:flex-row gap-8 lg:items-center justify-between">
          ...
          <div className="space-y-3.5 max-w-md text-left">
            <h4 className="text-sm font-bold text-white">Subscribe to Rate Sheet Alerts</h4>
            ...
            <form onSubmit={handleSubscribe} className="flex gap-2 relative max-w-sm">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full bg-slate-900/60 border border-slate-800/80 rounded-xl py-3 pl-11 pr-4 text-xs font-semibold focus:border-primary-500 focus:outline-none transition-colors text-white"
                />
              </div>
              <button
                type="submit"
          ...
          <div className="flex flex-col sm:flex-row gap-6 text-xs text-slate-500 items-start lg:items-end justify-end">
            <div>
            ...
            <div className="flex gap-4">
              ...
              <span className="text-slate-800">|</span>
              <a href="#" className="hover:text-slate-350 transition-colors">GDPR SLA</a>
            </div>
          </div>
