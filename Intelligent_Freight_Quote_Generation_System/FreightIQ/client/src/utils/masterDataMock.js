export const INITIAL_MASTER_DATA = {
  ...
  ports: [
    { UNLOCODE: 'INMAA', portName: 'Chennai (Chennai Port INMAA)', portType: 'Sea', iataCode: 'MAA', city: 'Chennai', countryCode: 'IN', location: '13.0827° N, 80.2707° E', timezone: 'UTC+05:30', active: true },
    { UNLOCODE: 'SGSIN', portName: 'Singapore (Port of Singapore SGSIN)', portType: 'Sea', iataCode: 'SIN', city: 'Singapore', countryCode: 'SG', location: '1.3521° N, 103.8198° E', timezone: 'UTC+08:00', active: true },
    { UNLOCODE: 'INNSA', portName: 'Nhava Sheva / JNPT (INNSA)', portType: 'Sea', iataCode: 'BOM', city: 'Navi Mumbai', countryCode: 'IN', location: '18.9500° N, 72.9500° E', timezone: 'UTC+05:30', active: true },
    { UNLOCODE: 'AEJEA', portName: 'Jebel Ali Port (AEJEA)', portType: 'Sea', iataCode: 'DXB', city: 'Dubai', countryCode: 'AE', location: '25.0112° N, 55.0617° E', timezone: 'UTC+04:00', active: true },
    { UNLOCODE: 'USLAX', portName: 'Port of Los Angeles (USLAX)', portType: 'Sea', iataCode: 'LAX', city: 'Los Angeles', countryCode: 'US', location: '33.7288° N, 118.2620° W', timezone: 'UTC-08:00', active: true },
    { UNLOCODE: 'CNSHA', portName: 'Port of Shanghai (CNSHA)', portType: 'Sea', iataCode: 'PVG', city: 'Shanghai', countryCode: 'CN', location: '31.2243° N, 121.4691° E', timezone: 'UTC+08:00', active: true },
    { UNLOCODE: 'DEHAM', portName: 'Port of Hamburg (DEHAM)', portType: 'Sea', iataCode: 'HAM', city: 'Hamburg', countryCode: 'DE', location: '53.5458° N, 9.9644° E', timezone: 'UTC+01:00', active: true },
    { UNLOCODE: 'INMUN', portName: 'Mundra Port (INMUN)', portType: 'Sea', iataCode: 'MUN', city: 'Mundra', countryCode: 'IN', location: '22.7444° N, 69.7061° E', timezone: 'UTC+05:30', active: true },
    { UNLOCODE: 'INCCU', portName: 'Kolkata Port (INCCU)', portType: 'Sea', iataCode: 'CCU', city: 'Kolkata', countryCode: 'IN', location: '22.5726° N, 88.3639° E', timezone: 'UTC+05:30', active: true },
    { UNLOCODE: 'INCOK', portName: 'Cochin Port (INCOK)', portType: 'Sea', iataCode: 'COK', city: 'Kochi', countryCode: 'IN', location: '9.9312° N, 76.2673° E', timezone: 'UTC+05:30', active: true }
  ],
  tradeLanes: [
